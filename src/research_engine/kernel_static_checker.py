# Copied from ScalingIntelligence/KernelBench (MIT licensed) at commit main
# Source: https://github.com/ScalingIntelligence/KernelBench/blob/main/src/kernelbench/kernel_static_checker.py
# Upstream authors: KernelBench team (Stanford Scaling Intelligence Lab)
# Vendored unchanged on 2026-04-11. Do not edit in place; re-vendor from upstream
# to pick up new checks (reward-hacking defenses evolve rapidly).
#
# Noeris uses this as an advisory check during kernelbench-eval: the speedup
# report is annotated with static_check: pass|fail but the result is not
# blocked. See kernelbench.py::_run_static_check.
