...
\author{
  ...
  \texttt{github.com/0sec-labs/noeris}
}
...
\url{https://github.com/0sec-labs/noeris} (MIT).
\end{abstract}
...
\url{https://github.com/0sec-labs/noeris} under the MIT License. We make thirteen contributions:
...
\url{https://github.com/0sec-labs/noeris} under the MIT License.
